...
let form = useForm ({
    company_id :  '' ,
    company_name :   ''  , 
    receive_report_date   :  { date : localDate  , time :  ''   , show_time : false  }, 
    report_date           :  { date : '2023-12-11' , time : ''  , show_time : false }, 

    external_reference   : '123' , 
    card_number   : '123' , 

    insurance_start_date    :  { date : '2023-12-01'  , time : '' , show_time : false }   , 
    insurance_end_date      :  { date : '2023-12-10' , time : '' , show_time : false } , 
    accident_date           :  { date : '2023-12-09' , time : '' , show_time : false }  , 

    insurance_name  : 'محمد'  , 
    vehicle_type  : 'افانتي الأغبياء'    , 
    plate_number   : '123'   , 
    report_party_id  : '2' , 
    currency_type  : ''   , 
    reserve  : ''         , 
    ...
    date_errors :   {  accident_date_error  : '' , report_date_error   : '' ,  report_accident_date_error : ''  , 
                       accident_time_error  : '' , report_time_error   : '' ,  report_accident_time_error : '' , report_receive_report_time_error : ''  } ,
}); 
                    ...
                    <div class="row g-3"  >
                            ...
                            <hr />
                                    ...
                                    <div class="col-12">
                                        <button type="buttom" 
                                            @click="Create()"
                                        :disabled="form.processing"   class="btn btn-primary submit"> {{ form.processing ?  'جاري حفظ الملف ...' : 'حفظ الملف'  }}</button>
                                    </div>
