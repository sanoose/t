...
let  years =  ref (["2020" , "2021" , "2022" , "2023" , "2024"]) ;
const form = useForm({
...
function FilesSearch(e) {
  form.get(route("Archiving.Files.FilesDeleted"), { preserveState: true });
}

function  FilesRestore (  id , name ) {
    Swal.fire({
        title: "استرجاع الملف  ",
        icon: 'info',
        text: ` هل انت متأكد من استرجاع   الملف  رقم    ${name}  ؟`,
        type: "warning",
        ...
        preConfirm: () => {
            ...
            router.visit(route('Archiving.Files.FilesRestore',id), 
            { method: 'get'  ,  preserveScroll: true  ,
            onSuccess : () =>  toast.success("تم استرجاع بنجاح") ,
            onError   : () =>  toast.error("خطأ لم يتم استرجاع ")   ,
...
<Head title="عرض  الملفات المحذوفة " />
    <AppLayoutArchive > 
                    <h3> عرض    الملفات المحذوفة </h3>
                    <hr>
                    <div class="row">
                    <div class="col-md-12">
                                            ...
                                            <td>
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><span class="dropdown-item btn_edit btn" 
                                                            @click="FilesRestore(file.id , `${file.company_name}/${file.year}/${file.folder_number}`  )"
                                                      >استرجاع</span></li>
