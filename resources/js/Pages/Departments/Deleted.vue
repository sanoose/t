...
function UserSearch(e) {
  form.get(route("users.UsersDeleted") , { preserveState: true } );
}



function UsersRestore(id , name ) {
    Swal.fire({
        ...
        preConfirm: () => {
            router.visit(route('Users.UsersRestore',id), 
                        ...
                        <div class="table-wrap">
                                    ...
                                    <table class=" table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            @click="UsersRestore(user.id , user.name )"
                                            >استرجاع  </button>
                                            </td>
                                            </tr>
                                        </tbody>
